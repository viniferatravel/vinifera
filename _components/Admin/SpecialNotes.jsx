...
const SpecialNotes = ({selectedPack}) => {

    return (
        <section className="py-8 px-4 bg-white w-[95%]">
            <div className='ml-8'>
                <h2 className="text-3xl font-bold text-left text-gray-800 mb-8">Special Notes</h2>
                <div className="max-w-4xl mx-auto">
                <ul className="list-none space-y-2 text-md">
                        {selectedPack?.special_notes?.map((highlight, index) => {
                            return (
