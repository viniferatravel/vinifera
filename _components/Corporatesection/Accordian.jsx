    ...
    return (
        <>
            <div className="w-[95%] m-auto lg:mt-5 mb-5 xl:mt-10">
                ...
                <p className='w-full lg:w-[60%] m-auto text-center mt-8 mb-16'>Common Inquiries About Our Corporate Travel Packages, Services, and How We Cater to Your Business Needs</p>
