...
const Landing = () => {
  ...
  return (
    <div className="relative h-[70vh] w-full">
      <Image
        src={IMAGES.testimonialslanding}
        alt="testimonials-landing"
        fill
      ...
      <div className="absolute top-0 left-0  w-full h-full flex justify-center items-center">
        <div className="m-5 lg:m-12 w-full h-full flex flex-col justify-center items-start gap-10">
          ...
          <div className="w-[70%] lg:w-1/3">
            ...
            >
              Discover how our travelers enjoyed hassle-free journeys, stunning
              destinations, and comfortable stays—all while creating
              unforgettable memories with our budget-friendly packages!
            </motion.p>
          </div>
          <div>
            <button
